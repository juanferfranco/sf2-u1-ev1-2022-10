 ...
 * a 1-char delimiter.
 */
public class SerialControllerBinary : MonoBehaviour
{
    [Tooltip("Port name with which the SerialPort object will be created.")]
    public string portName = "/dev/ttyUSB1";
    ...
    protected SerialThreadBinary serialThread;


    public void OpenPort()
    {
        serialThread = new SerialThreadBinary(portName,
            baudRate,
            reconnectionDelay,
            maxUnreadMessages,
            dropOldMessage);
